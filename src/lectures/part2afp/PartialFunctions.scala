...
object PartialFunctions extends App{
  ...
  // My solution...
  val aAnonymousPartialFunction = new PartialFunction[Int, String] {
  ...
  val chatbot: PartialFunction[String, String] = {
    case "hi" => "Hi!!! I am chatbot! how you doing?"
    case "fine" => "That's awesome I friend!!"
  }
  ...
  val chatbotSolution: PartialFunction[String, String] = {
  ...
  scala.io.Source.stdin.getLines().map(chatbotSolution).foreach(println)
