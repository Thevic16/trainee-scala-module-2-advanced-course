...
/*
  // my solution
  //implicit def personOrdering: Ordering[Person] = Ordering.fromLessThan(_.name(0) < _.name(0))
  // solution
 ...
 */
  ...
  object UnitCountOrdering {
    implicit val unitCountOrdering: Ordering[Purchase] = Ordering.fromLessThan(
  ...
  val listPurchase = List(Purchase(2, 60), Purchase(1, 10), Purchase(2, 20), Purchase(3, 30), Purchase(4, 10), Purchase(1, 50))
  println(listPurchase.sorted)
}
